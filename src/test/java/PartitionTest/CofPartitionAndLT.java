...
public class CofPartitionAndLT {
    public static void main(String[] args) throws IOException {
        File file = new File("G:/lab/LabData/半径30的分区数3的c从0.01到0.5的LT和分区解码率对比情况单LT版本.txt");
        file.createNewFile();
...
//                new SpaceHelper(LPFCExperiment, LPFCdegreeDistribution, NodeTypeEnum.PARTITION_LT));
       ...
       // System.out.println("LT:" + LT + " LPFC:" + LPFC);
        ...
        //out.write(cofficient_of_c + " " + LTResult + " " + LPFCResult + " " + "\r\n");
        out.write(cofficient_of_c + " " + LTResult + " " + "\r\n");
        out.flush();
    }
}
