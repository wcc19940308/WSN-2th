...
//TODO 目前想到的解决方案是将M取为当前的节点的邻居中最大的度，并且对于一个相同的数据包，同一个节点不会接受2次以上
//TODO 即对于随机游走，如果最后落的节点已经有过该数据包的数据了，那么继续转发，即采用二次转发的形式
...
//TODO 收集阶段Sink向网络中发出收集信号，使用类似时刻序列一样的机制，让里层节点按照一定的时间间隔将自身的数据包按层向外传递
